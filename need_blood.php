...
<div><textarea class="form-control" name="message" required></textarea></div></div>
</div>
<div class="row">
<div class="col-lg-4 mb-4">
...
$sql="INSERT INTO need_blood(blood_group, message) values('{$blood_group}','{$message}')";
$result=mysqli_query($conn,$sql) or die("query unsuccessful.");}
?>
      ...
      <div class="card" style="width:300px">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              ...
              <b>Camp Location : </b> <?php echo $row['camp_location']; ?><br>
            </p>
